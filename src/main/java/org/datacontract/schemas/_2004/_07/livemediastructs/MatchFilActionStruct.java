...
/**
 * <p>Java class for MatchFilActionStruct complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MatchFilActionStruct">
 *   &lt;complexContent>
 ...
 *         &lt;element name="LstEventMatchFilActionStruct" type="{http://schemas.datacontract.org/2004/07/LiveMediaStructs.FilActionNS}ArrayOfEventMatchFilActionStruct" minOccurs="0"/>
 *         &lt;element name="LstTeamMatchFilActionStruct" type="{http://schemas.datacontract.org/2004/07/LiveMediaStructs.FilActionNS}ArrayOfTeamMatchFilActionStruct" minOccurs="0"/>
...
@XmlType(name = "MatchFilActionStruct", namespace = "http://schemas.datacontract.org/2004/07/LiveMediaStructs.FilActionNS", propOrder = {
    "codeMatch",
    "competitionName",
    "dateAndTime",
    "day",
    "idMatch",
    "lstCIS",
    "lstEventMatchFilActionStruct",
    "lstTeamMatchFilActionStruct",
    "seasonEndDate",
    "seasonStartDate"
})
public class MatchFilActionStruct {
    ...
    @XmlElementRef(name = "LstEventMatchFilActionStruct", namespace = "http://schemas.datacontract.org/2004/07/LiveMediaStructs.FilActionNS", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfEventMatchFilActionStruct> lstEventMatchFilActionStruct;
    ...
    protected JAXBElement<ArrayOfTeamMatchFilActionStruct> lstTeamMatchFilActionStruct;
    ...
    /**
     * Gets the value of the lstEventMatchFilActionStruct property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfEventMatchFilActionStruct }{@code >}
     *     
     */
    public JAXBElement<ArrayOfEventMatchFilActionStruct> getLstEventMatchFilActionStruct() {
        return lstEventMatchFilActionStruct;
    }

    /**
     * Sets the value of the lstEventMatchFilActionStruct property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfEventMatchFilActionStruct }{@code >}
     *     
     */
    public void setLstEventMatchFilActionStruct(JAXBElement<ArrayOfEventMatchFilActionStruct> value) {
        this.lstEventMatchFilActionStruct = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfTeamMatchFilActionStruct }{@code >}
     *     
     */
    public JAXBElement<ArrayOfTeamMatchFilActionStruct> getLstTeamMatchFilActionStruct() {
     ...
     *     
     */
    public void setLstTeamMatchFilActionStruct(JAXBElement<ArrayOfTeamMatchFilActionStruct> value) {
